...
using Agents.VictorInsurance.Business.Master.Infrastructure.Bootstrapper;
using Agents.VictorInsurance.Business.Master.Repository.Boostrapper;
using Agents.VictorInsurance.Business.Master.Services.Boostrapper;
using Agents.VictorInsurance.GenericRepository.Bootstrapper;

namespace Agents.VictorInsurance.Api.Master
{
    public class Startup
    {
        public Startup(IConfiguration configuration)
        {
            var configBuilder = new ConfigurationBuilder()
                   .AddJsonFile("appsettings.Master.json",
                               optional: false,
                               reloadOnChange: true);
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            AddCors(services);
            RegisterMasterServices(services);
        }
        ...
        private void AddCors(IServiceCollection serviceCollection)
        {
         ...
         private void RegisterMasterServices(IServiceCollection serviceCollection)
        {
